...
final class Response
{
     ...
     *
     * @param  mixed  $data
     *            Los datos que se enviarán en la respuesta.
     * @param  int    $status
     *            El código de estado HTTP. Por defecto es 200 (OK).
     * @param  string $format
     *            El formato de la respuesta. Puede ser 'html' o 'json'. Por defecto es 'html'.
     * @return void
     */
     ...
     *            Los datos que se enviarán en formato JSON.
     * @param  int          $status
     *            El código de estado HTTP. Por defecto es 200 (OK).
     * @return void
     */
    public function json(array|object $data, int $status = 200): void
    {
        ...
        $this->send(json_encode($data, JSON_PRETTY_PRINT), $status, __FUNCTION__);
    }
     ...
     *
     * @param  mixed $data
     *            Los datos que se codificarán en JSON.
